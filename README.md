...
| [GuardReasoner: Towards Reasoning-based LLM Safeguards](https://arxiv.org/pdf/2501.18492) | GuardReasoner, a new safeguard for LLMs, ... guiding the guard model to learn to reason. On experiments across 13 benchmarks for 3 tasks, GuardReasoner proves effective. |
